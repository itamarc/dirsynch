...
/**
 * TableModel with a set of FilePair's and an attribute to define if the equal
 * pairs should be hidden or not.
 * 
 * @author Itamar
 */
public class FileVOTableModel extends DefaultTableModel {
    ...
    /**
     * Returns the FilePair's Vector with all files or only the different ones
     * depending on the hideEquals attribute.
     * 
