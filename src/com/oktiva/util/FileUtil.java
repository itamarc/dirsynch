 ...
 * FileUtil.java
 *
 * Created on 20 de Fevereiro de 2003, 16:31
 */
...
public final class FileUtil {
	 ...
	 */
	public static final void copy(File src, File dest)
	throws IOException {
	 ...
	 * @return the contents of the file
	 */
	public static final String readFile(FileReader fileReader)
	throws IOException {
	 ...
	 */
	public static final String[] readFileAsArray(File file)
	throws IOException {
	 ...
	 * @return the contents of the file split in an array
	 */
	public static final String[] readFileAsArray(String filename)
	throws IOException {
	 ...
	 * @return the contents of the file split in an array
	 */
	public static final String[] readFileAsArray(FileReader fileReader)
	throws IOException {
	 ...
	 */
	public static final void writeFile(String text, File file)
	throws IOException {
	 ...
	 * @throws IOException If the write operation fails.
	 */
	public static final void writeFile(String text, String filename)
	throws IOException {
